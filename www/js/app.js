...
.config(function ($stateProvider, $urlRouterProvider) {
    ...
    $stateProvider
        ...
        .state('listCollecteurs', {
            url: '/listCollecteurs',
            templateUrl: 'templates/form/listCollecteurs.html',
            controller: 'listCollecteursCtrl'
        })
...
.controller("LoginCtrl", function ($scope, $http, $location, $window) {
    $scope.logOn = function () {
        var link = "server/API/loginAsDonneur.php";
        $http.post(link, {
                'email': $scope.email,
                'mdp': $scope.mdp
            })
